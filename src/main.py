...
- The functionalities must be collected under five menus: File, Edit, Conversion, 
Segmentation, and Edge Detection. Also, each functionality must have a button.
- You can use toolbar or group boxes for that purpose.
